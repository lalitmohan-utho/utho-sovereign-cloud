  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white shadow-hero hover:shadow-glow transform hover:scale-105 font-semibold",
        accent: "gradient-accent text-accent-foreground shadow-card hover:shadow-glow transform hover:scale-105",
        pricing: "border-2 border-primary bg-background text-primary hover:gradient-hero hover:text-white hover:border-transparent font-semibold",
      },
      size: {
